...
isdistributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or
...
public abstract class RecyclerViewCursorAdapter<T extends RecyclerViewCursorViewHolder> extends RecyclerView.Adapter<T> {
    /**
     * The Context of the excursionListAdapter.
     */
     ...
     * @param flags Flags used to determine the behavior of the excursionListAdapter.
    ...
    protected void setupCursorAdapter(Cursor cursor, int flags, final int resource, final boolean attachToRoot) {
        this.mCursorAdapter = new CursorAdapter(mContext, cursor, flags) {
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                // Bind excursionsCursor to our ViewHolder
    ...
    /**
     * The number of elements in the excursionListAdapter is the number of elements in the CursorAdapter.
     */
    @Override
